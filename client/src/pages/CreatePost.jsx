...
export default function CreatePost() {
  ...
  useEffect(() => {
    if (id) {
      axios.get(`https://elegant-blog-api.onrender.com/api/posts/${id}`, { headers: { Authorization: `Bearer ${token}` } })
  ...
  const handleSubmit = async (e) => {
    ...
    if (id) await axios.put(`https://elegant-blog-api.onrender.com/api/posts/${id}`, formData, config);
    else await axios.post('https://elegant-blog-api.onrender.com/api/posts', formData, config);
    navigate('/mine');
  };
